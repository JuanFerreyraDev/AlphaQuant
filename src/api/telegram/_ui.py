...
def _kb_bot(paused: bool) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🗑️ Remove Symbol", callback_data="action:remove_symbol")],
...
def _kb_futures(margin_type: str) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📋 View Positions", callback_data="action:positions")],
        [InlineKeyboardButton("🔎 Scan Market", callback_data="action:scan")],
        [InlineKeyboardButton("⚙️ Modify Leverage", callback_data="action:leverage")],
        ...
        [InlineKeyboardButton("🚨 Panic Button (Close All)", callback_data="action:panic")],
